...
void AMainMenuController::HandleAfterUIRemove()
{
	if (IsValid(MainMenu)) {
		switch ((EMainMenuMainScreen)MainMenu->GetCurrentMainScreen()) {
		case EMainMenuMainScreen::MAIN_MENU:
		{
		...
		case EMainMenuMainScreen::LOBBY:
		{
			SetShowMouseCursor(true);
